...
if(isset($_GET['eliminar'])){
    ...
    if(unlink($directorio.'\imagenes\\'.$archivo)){
    ...
    if($_FILES['foto']['name'] != ""){ // El campo foto contiene una imagen...
        ...
        if ((($_FILES["foto"]["type"] == "image/gif")
            ...
            if ($tamano <= 1000000) {
                ...
                header("Location: ".$_SERVER['PHP_SELF']."?error=noTamano");
                exit;
            }
...
<html>
    ...
    <body>
        ...
        <?php 
            $errores = ["noImagen" => "No se ha subido ninguna imagen.", 
                        "noFormato" => "Formato erróneo suba otra imagen.",
                        "noTamano" => "Tamaño malo, :v"];
            if (isset($_GET["error"])) {
                echo "<div class='msg'>".$errores[$_GET['error']]."</div>";
            } else if(isset($_POST['submit'])) { 
                echo "<div class='msg'>El archivo ha sido cargado satisfactoriamente.</div>";
            } 
        ?>
